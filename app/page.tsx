      ...
      <section className="project-about">
        <div className="page-shell project-landmark">
          ...
          <div className="project-about-copy">
            ...
            <p>横琴天啟（华发）跨境电商产业园拓展区又名华发天啟 T3 栋，坐落于横琴粤澳深度合作区荣澳道 128 号，位处金融岛 CBD 核心。项目东临十字门大道，西靠都会道，南接洋环路，北望天沐河滨水景观带，处于琴澳中央商务区中轴线上。</p>
            <p>项目紧临横琴金融基地、横琴口岸、珠机城轨金融岛站、跨境电商创新产业园首发区及澳门青年创业基地等核心配套，致力打造粤港澳大湾区一流的琴澳一体化商务综合体。</p>
          </div>
        </div>
      </section>
