    ...
    <main>
        ...
        <div className="page-shell project-landmark project-landmark-full">
          ...
          <div className="project-about-copy">
            <div className="project-about-intro">
              <img src={asset("/huafa-property-logo.jpg")} alt="华发物业 Logo" width="640" height="231" loading="lazy" decoding="async" />
              <p>华发物业服务有限公司，隶属华发集团公司，国家一级资质物业管理企业。华发物业，创立于 1985 年，是一流的社区生活运营商和综合设施服务商，位列中国物业服务百强企业第 13 位，致力于发展全业态高端服务，向着成为拥有全球视野、坚持品质创新、崇尚知识管理、践行社会责任的社区生活运营商和综合设施服务商目标不断迈进。</p>
            </div>
            <p>横琴粤澳深度合作区(华发)跨境电商产业园拓展区又名华发天啟 T3 栋，项目位于珠海市横琴粤澳深度合作区境内，占位横琴金融岛金边三公里CBD核心地段，背靠小横琴山，与澳门隔海相望，奢享一线揽澳海景，兼有较佳的海景、山景、园景、城市景观，具有得天独厚的区位优势和无可比拟的景观优势。</p>
          </div>
        </div>
      </section>
      ...
      <section className="ifc-security" id="security-management">
        <div className="page-shell security-story">
          ...
          <div className="security-photo-composition monitoring-composition"><img src={asset("/security-monitoring-complete.jpg")} alt="T3 监控中心实时安全管理" width="836" height="557" loading="eager" decoding="async" /><div aria-hidden="true" /></div>
        </div>
        ...
        <div className="page-shell tight-story">
          ...
          <div className="security-photo-composition tight-composition"><img src={asset("/security-emergency-drill-complete.jpg")} alt="T3 安管团队开展防暴应急演练" width="1707" height="1280" loading="eager" decoding="async" /><div aria-hidden="true" /></div>
        </div>
        ...
        <div className="page-shell security-story equipment-story">
          ...
          <div className="security-photo-composition equipment-composition"><img src={asset("/equipment-inspection-complete.jpg")} alt="工程人员开展电力设备安全检查" width="1114" height="744" loading="eager" decoding="async" /><div aria-hidden="true" /></div>
        </div>
      </section>
